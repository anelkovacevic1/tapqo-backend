  ...
  return (
    <footer className="border-t border-ui-border-base w-full bg-slate-900">
      <div className="content-container flex flex-col w-full">
        <div className="flex flex-col gap-y-6 xsmall:flex-row items-start justify-between py-20">
          <div className="flex flex-col gap-y-4">
            ...
            <p className="text-slate-400 text-sm max-w-xs">
              Digitalna NFC vizit kartica za moderan poslovni svijet. Jednostavno. Elegantno. Pametno.
            </p>
          ...
          <div className="text-small-regular gap-10 md:gap-x-16 grid grid-cols-2 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-y-2">
              <span className="txt-small-plus text-white font-semibold">Informacije</span>
        ...
        <div className="flex w-full mb-16 justify-between text-slate-500 border-t border-slate-800 pt-8">
          <Text className="txt-compact-small">
            © {new Date().getFullYear()} TAPQO. Sva prava zadržana.
          </Text>
          <Text className="txt-compact-small">
            Napravljeno u Bosni i Hercegovini
          </Text>
        </div>
      </div>
    </footer>
